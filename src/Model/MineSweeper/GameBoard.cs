...
namespace Model.MineSweeper
{
    internal class GameBoard : IGameBoard
    {
        ...
        public const double MinimumMineProbability = 0.1;
        public const double MaximumMineProbability = 0.9;
        ...
        public static GameBoard CreateRandom( int width, int height, int seed, double mineProbability )
        {
            ...
            else if ( mineProbability < MinimumMineProbability || mineProbability > MaximumMineProbability )
            {
